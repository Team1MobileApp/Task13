			...
			<div class="col-lg-12">
				<div class="control-group form-group">
					<div class="controls">
						<form id="form1">
							<fieldset>
								<input name="route" type="select" list="routeIds"
								...
								<div class="btn-group" btn-lg data-toggle="buttons">
									<!-- <label >  -->
									<input type="button" name="direction" id="direction"
										autocomplete="on" value="INBOUND" class="btn btn-info btn-lg">
									<!-- </label> -->
						...
						<form method="GET" name="waitingTime" id="form2"
							action="manage.do">
							<input name="route" type="hidden" value="" id="route1"> 
							<input name="direction" type="hidden" value="" id="direction1"> 
							<input type="select" list="streets" class="form-control" id="name"
								name="stop"
							...
							<input name="Checkbox1" type="checkbox"
								id="Checkbox1" value="allbuses" checked /> <label
								for="Checkbox1">Show all buses arriving to stop</label> <br>
							<br>

							<div id="success"></div>
							<!-- For success/fail messages -->
							<input type="button" class="btn btn-primary" value="Get Times" id="submitbtn">
						</form>
					</div>
				</div>
